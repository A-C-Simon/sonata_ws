...
CKPT_PATH = WORK_DIR / "checkpoints" / "diffusion_v2gt_finetune_mixed_scaffold_seed43" / "epoch_2.pth"
RESULTS_DIR = WORK_DIR / "results" / "apr17_morning"
RESULTS_PATH = RESULTS_DIR / "teacher_finetuned_str80_seed43_ep2.json"
NUM_FRAMES = 50
DEVICE = "cuda"
MAX_PTS = 20000
SEED = 42
