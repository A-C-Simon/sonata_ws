...
class RefinementDataset(Dataset):
    ...
    def __init__(
        ...
        root: str,
        split: str = "train",
        coarse_voxel_size: float = 0.2,
        fine_voxel_size: float = 0.1,
        ...
        Args:
            ...
            coarse_voxel_size: Coarse voxels (e.g. 0.2; simulates diffusion at 0.1)
            fine_voxel_size: Dense target voxels (match train diffusion / boost: 0.1)
            ...
            gt_subdir: GT folder under root (e.g. ground_truth_v2)
            gt_name_suffix: GT file suffix (e.g. _v2)
        """
